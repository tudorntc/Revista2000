...
var options = {
    ...
    events: {
        ...
        onBeforeAjaxPageLoad: function onBeforeAjaxPageLoad(event) {
            console.log('onBeforeAjaxPageLoad triggered');
            // Allow AJAX page loading
            return true;
        },
        ...
        onAfterAjaxPageLoad: function onAfterAjaxPageLoad(data) {
            console.log('onAfterAjaxPageLoad triggered', data);
            // Remove loading animation and handle navigation
            var loadingElement = document.getElementById('loading-animation');
            if (loadingElement) {
                loadingElement.style.display = 'none';
            }

            // Example: Update the page content or perform additional actions
